...
import { Appeal, BaseModalProps, AppealReviewData, ReviewTab } from "@/types/admin-dashboard";
...
export default function AppealReviewModal({
  ...
  const [details, setDetails] = useState(
    "Appeal submitted by " + appeal.userName
  );
                ...
                <div className="mt-3 space-y-2">
                  <label className="flex items-center gap-2">
                    <input
                      ...
                      onChange={(e) =>
                        setResolution(e.target.value as "approved" | "rejected")
                      }
                    />
                    <span className="text-slate-700">Approve Appeal</span>
                  </label>
                  <label className="flex items-center gap-2">
                    <input
                      type="radio"
                    ...
                    />
                    <span className="text-slate-700">Reject Appeal</span>
                  </label>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="rounded-lg border-2 border-dashed border-slate-300 p-8 text-center">
                <p className="text-slate-600">
                  No attachments for this appeal
                </p>
              </div>
            </div>
          )}
            ...
            <div className="space-y-4">
              <div className="bg-slate-50 rounded-lg p-4">
                <p className="text-sm text-slate-600">
                  <strong>Created:</strong> {appeal.date} by {appeal.userName}
                </p>
